            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-4">
              {[
                ...
                <div key={label} className="min-w-0">
                  ...
                  <div
                    className={label === "Email" ? "break-all" : "break-words"}
              ...
              {followUps.length === 0 ? (
                ...
                followUps.slice(0, 10).map((task) => {
                  ...
                  return (
                    <div key={task.id}>
                    <div
                      className="flex flex-col gap-2 py-2.5 border-b border-border"
                      style={{
                        borderLeft: isOverdue ? "2px solid #f87171" : undefined,
                        paddingLeft: isOverdue ? 8 : undefined,
                      }}
                    >
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        <span
                          style={{
                            ...
                            padding: "2px 6px",
                            borderRadius: "var(--radius-sm)",
                            background: task.status === "COMPLETED" ? "#d1fae5" : isOverdue ? "#fef2f2" : "var(--border-light)",
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: "var(--text-muted)" }}>
                      {displayLabel(assignedUser.email, "Agent")}
                    </div>
                  </div>
                </div>
